...
RUN apt update && \
    ...
    curl -L https://archive.apache.org/dist/hive/hive-${METASTORE_VERSION}/apache-hive-${METASTORE_VERSION}-bin.tar.gz | tar zxf - && \
    cp apache-hive-${METASTORE_VERSION}-bin/lib/hive-serde-${METASTORE_VERSION}.jar ${HIVE_HOME}/lib/ && \
